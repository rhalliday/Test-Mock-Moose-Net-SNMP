...
Test::Mock::Moose::Net::SNMP - Perl extension for mocking Net::SNMP in your unit tests.
...
has q{session_failure} => (
    is      => q{rw},
    isa     => q{Bool},
    clearer => q{clear_session_failure},
);
